...
class Settings(BaseSettings):
    ...
    ollama_model: str = Field(default="gemma3:4b-it-qat", env="OLLAMA_MODEL")
    ...
    # n8n 워크플로우 자동화 설정
    n8n_api_url: str = Field(default="http://localhost:5678/api/v1", env="N8N_API_URL")
    n8n_webhook_url: str = Field(default="http://localhost:5678/webhook", env="N8N_WEBHOOK_URL")
    n8n_email: str = Field(default="admin@example.com", env="N8N_EMAIL")
    n8n_password: str = Field(default="Admin123!", env="N8N_PASSWORD")
    n8n_api_key: str = Field(default="", env="N8N_API_KEY")
    
    # Dify AI Platform 설정
    dify_api_url: str = Field(default="http://localhost/console/api", env="DIFY_API_URL")
    dify_console_api_key: str = Field(default="", env="DIFY_CONSOLE_API_KEY")
    dify_api_key: str = Field(default="", env="DIFY_API_KEY")
    dify_chart_agent_key: str = Field(default="", env="DIFY_CHART_AGENT_KEY")
