"""
DX-AI Manufacturing Copilot - Copilot 모듈
"""

from .config import settings
from .data_models import *
# LLM Client는 이제 AI 모듈에서 import
from ..ai.core.llm_client import OllamaClient, get_ollama_client, create_ollama_client
...
# 제품 예측 모델링 엔진 클래스들 추가
from .product_modeling_engine import (
