...
from src.core.cost_optimization_engine import CostOptimizationEngine, QualityTarget
from src.core.advanced_optimization import AdvancedOptimizationEngine
from src.core.tab_chat_managers.cost_management_chat import CostManagementChatManager
...
class CostManagementEngine:
    ...
    def __init__(self):
        ...
        self.cost_chat_manager: Optional[CostManagementChatManager] = None
    ...
    def initialize(self, data_path: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            if "chat_manager" in st.session_state:
                self.cost_chat_manager = CostManagementChatManager(
                    st.session_state.chat_manager
                )
                
                # Context 데이터 업데이트
                context_data = self.cost_optimization_engine.get_context_data()
                self.cost_chat_manager.update_context_data(context_data, "최근 1개월")
