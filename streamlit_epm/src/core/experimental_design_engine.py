...
class ReportGenerationEngine(ExperimentalDesignEngine):
    ...
    def __init__(self):
        ...
        self.report_templates = {
            "실험 계획 요약": self._generate_experiment_summary_report,
            "최적화 결과": self._generate_optimization_report,
            "DoE 분석": self._generate_doe_analysis_report,
    ...
    def generate_report(self, report_type: str, include_sections: List[str],
                       ...
                       llm_settings: Dict[str, Any] = None) -> Dict[str, Any]:
        """보고서 생성"""
        # 보고서 유형별 생성기 선택
        report_generator = self.report_templates.get(report_type, self._generate_experiment_summary_report)
        
        # 보고서 생성
        content = report_generator(include_sections, report_length, experiment_data, optimization_data)
